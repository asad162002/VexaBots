    ...
    <PageTheme value="light">
      ...
      <main className="min-h-screen bg-cream px-6 pt-28 text-cocoa sm:px-10">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 flex min-h-[300px] items-center justify-center border border-cocoa/20">
            {media && media.length > 0 ? (
              <p className="font-data text-xs opacity-50">TODO: PropertyGallery, {media.length} photo(s)</p>
            ) : (
              <p className="font-data text-xs opacity-40">TODO: branded default fallback image (no photos uploaded yet)</p>
            )}
          </div>
